...
function broadcastResults(attackRolls, damageResults) {
    console.log("sending", attackRolls, damageResults);
...
Examples:
  ...
  '4n vs 14 dealing 2d10'
        ...
        broadcastResults(attackRollsDiv.innerHTML, damageResultsDiv.innerHTML);
